...
LocalizationErrorMonitor::LocalizationErrorMonitor() : Node("localization_error_monitor")
{
  ...
  localization_accuracy_pub_ = this->create_publisher<std_msgs::msg::Float32MultiArray>("/localization_accuracy", 1); //HJK_240619 Commit[Cart v1.0, f4d8f9d]
...
void LocalizationErrorMonitor::onOdom(nav_msgs::msg::Odometry::ConstSharedPtr input_msg)
{
  ...
  //HJK_240619 Commit[Cart v1.0, f4d8f9d] {
